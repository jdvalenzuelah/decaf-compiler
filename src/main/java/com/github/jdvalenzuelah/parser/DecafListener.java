...
public interface DecafListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecafParser#datatype}.
	 * @param ctx the parse tree
	 */
	void enterDatatype(DecafParser.DatatypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecafParser#datatype}.
	 * @param ctx the parse tree
	 */
	void exitDatatype(DecafParser.DatatypeContext ctx);
	/**
